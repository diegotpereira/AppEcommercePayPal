...
export class BillingAddressComponent implements OnInit {
  ...
  setSameShippingAddressBilling(change: boolean) {
  ...
  private cloneAddress() {
    ...
    }, [UpdateOrderParams.billingAddressClone]).subscribe(() => this.showSuccessSnackBar(),
                                                      err => this.showErrorSnackBar());
  }
  ...
  private showSuccessSnackBar() {
    this.snackBar.open('Endereço de cobrança adicionado com sucesso. Redirecionando...', 'Close', {
      duration: 3000
    });
